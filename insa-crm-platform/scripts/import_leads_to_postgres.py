...
def import_leads():
    ...
    try:
        ...
        print("  PGPASSWORD='110811081108' psql -h localhost -U insa_crm_user -d insa_crm -c 'SELECT lead_id, lead_name, company_name, opportunity_score, priority_tier FROM leads ORDER BY opportunity_score DESC;'")
        print("\n  # View Tier 1 leads only:")
        print("  PGPASSWORD='110811081108' psql -h localhost -U insa_crm_user -d insa_crm -c 'SELECT lead_name, company_name, phone, email FROM leads WHERE priority_tier = 1 ORDER BY opportunity_score DESC;'")
